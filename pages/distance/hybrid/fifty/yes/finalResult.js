...
export default function FinalResult() {
  ...
  return <FinalResultCont>
    ...
    <div className="marginB" onClick={onClick3}>
      {compress3 === false ? <FinalResultTextBoxUI delay="4s" text="Combine..." src="/note.svg" fontsize="28"></FinalResultTextBoxUI> : <FinalResultTextBoxExtandUI src="/note.svg" text="Combine errands in order to make fewer trips."></FinalResultTextBoxExtandUI>}
    </div>
    <div className="marginB">
